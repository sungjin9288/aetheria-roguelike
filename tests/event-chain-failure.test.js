...
const CANONICAL_FAILURES = [
    ...
    },
    {
        ...
        step: 1,
        // 2026-09 Wave 14 F2: 스텝 역전 교정으로 loc이 '에테르 관문'(68) → '지하 미궁'(44)으로
        //   옮겨졌고, 문구도 함께 옮겼다(관문 → 미궁). 이 센서스는 문구를 그대로 핀하므로
        //   네 값이 같이 움직이는 것이 정상이다.
        loc: '지하 미궁',
        title: '봉인 너머의 목소리',
        choiceIndex: 1,
        choice: '귀를 막고 미궁을 빠져나간다',
        log: '미궁을 빠져나왔습니다. 목소리가 사라집니다. 무언가 잃은 것 같습니다.',
        reward: null,
    },
    {
