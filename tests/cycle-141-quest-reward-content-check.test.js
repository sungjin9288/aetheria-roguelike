...
// cycle 141 시점 baseline 75종 → cycle 142에서 7종 fix (quest 22/24/25/29/142/145/148).
// 향후 사이클에서 점진적으로 줄여나감.
const KNOWN_MISSING_REWARD_ITEMS = new Set([
    '강인함의 증표', '강화된 갑옷', '고대의 파편', '공허의 핵심',
    '기계 문명의 유산', '기적의 부적', '대연금술사 코트',
    '대장장이 망치', '도적의 망토', '무한의 결정체',
    '방랑자의 외투', '보스 사냥꾼 인장', '보스 사냥꾼 증표', '보스 토벌 증표',
    '부서진 기어', '부활의 깃털', '불의 시험 증표',
    '생존자의 반지', '세계 구원자의 증표', '세계 지도 원본', '세계 탐험 지도',
    '세트 완성의 증표', '수호자의 파편',
    '신화 사냥 훈장', '신화 전설 영혼', '심연 수호자의 코어',
    '심연 지배 증표', '심연의 결정', '심연의 파편',
    '에테르 집대성의 왕관', '에테르 탐사 보고서', '연금술사 장갑',
