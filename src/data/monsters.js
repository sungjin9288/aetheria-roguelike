export const MONSTERS = {
    ...
    '허무의 전령': {
        ...
        goldMult: 4.0,
        dropMod: 4.5,
        phase2: { name: '각성한 허무의 전령', atkBonus: 0.55, pattern: { guardChance: 0.05, heavyChance: 0.65 }, log: '허무의 전령이 공허의 메시지를 전달합니다! 존재 자체가 희미해집니다!', statusEffect: 'curse' },
    },
    // 심연 70층 보스
    '멸절의 사도': {
        isBoss: true,
        ...
        goldMult: 4.2,
        dropMod: 4.8,
        phase2: { name: '변모한 멸절의 사도', atkBonus: 0.6, pattern: { guardChance: 0.0, heavyChance: 0.7 }, log: '멸절의 사도가 완전한 소멸의 힘을 드러냅니다! 공간이 붕괴합니다!', statusEffect: 'burn' },
    },
    // 심연 80층 보스
    '공허의 심판자': {
        isBoss: true,
    ...
    '허무의 황제': {
        ...
        goldMult: 4.8,
        dropMod: 5.5,
        phase2: { name: '군림하는 허무의 황제', atkBonus: 0.7, pattern: { guardChance: 0.05, heavyChance: 0.72 }, log: '허무의 황제가 절대 군림의 힘을 해방했습니다! 세계가 그의 앞에 무릎을 꿇습니다!', statusEffect: 'curse' },
        phase3: { name: '허무의 절대 권능', threshold: 0.2, atkBonus: 1.1, defBonus: 25, pattern: { guardChance: 0.0, heavyChance: 0.82 }, log: '황제가 우주 자체를 지배합니다! 이것이 허무의 극치입니다!', statusEffect: 'burn' },
    },
    // 심연 100층 최종 보스 — 공허의 신
    '공허의 신': {
        isBoss: true,
