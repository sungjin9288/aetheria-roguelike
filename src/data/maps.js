export const MAPS = {
    ...
    '고요한 숲': { level: 1, type: 'dungeon', exits: ['시작의 마을', '잊혀진 폐허', '호수의 신전'], monsters: ['슬라임', '늑대', '숲의 정령', '거미떼'], desc: '새들의 지저귐 속에 긴장감이 감도는 숲입니다.', eventChance: 0.18 },
    '서쪽 평원': { level: 3, type: 'dungeon', exits: ['시작의 마을', '화염의 협곡', '사막 오아시스'], monsters: ['멧돼지', '들개', '코볼트', '초록슬라임'], desc: '넓은 초원이 펼쳐진 평화로운 지역입니다.', eventChance: 0.15 },
    '호수의 신전': { level: 5, type: 'dungeon', exits: ['고요한 숲'], monsters: ['물의 정령', '머맨', '거대 거북'], desc: '고대 수호신이 잠든 호수의 신전입니다.', eventChance: 0.2 },

    // 중반 지역 (Lv 5-20)
    '잊혀진 폐허': { level: 5, type: 'dungeon', exits: ['고요한 숲', '어둠의 동굴', '버려진 광산'], monsters: ['해골 병사', '고블린', '석상 가디언', '유령 기사'], desc: '오래된 문명의 흔적이 남아있는 폐허입니다.', eventChance: 0.18 },
    '버려진 광산': { level: 8, type: 'dungeon', exits: ['잊혀진 폐허', '어둠의 동굴'], monsters: ['광석골렘', '코볼트 광부', '광산 박쥐', '거대 지렁이'], desc: '금맥을 찾아 파헤쳐진 버려진 광산입니다.', eventChance: 0.2 },
    '어둠의 동굴': { level: 10, type: 'dungeon', exits: ['잊혀진 폐허', '버려진 광산', '암흑 성'], monsters: ['동굴 트롤', '박쥐 떼', '다크 엘프', '거대 지네', '암흑 마법사'], desc: '빛이 들지 않는 깊고 어두운 동굴입니다.', eventChance: 0.22 },

    // 화염 지역 (Lv 15-30)
    '화염의 협곡': { level: 15, type: 'dungeon', exits: ['서쪽 평원', '용의 둥지'], monsters: ['화염 정령', '용암 골렘', '파이어뱃', '화염 도마뱀'], desc: '뜨거운 용암이 흐르는 위험한 협곡입니다.', eventChance: 0.22 },
    '용의 둥지': { level: 25, type: 'dungeon', exits: ['화염의 협곡'], monsters: ['화염의 군주', '레드 드래곤', '화염 와이번', '드래곤 나이트'], bossMonsters: ['화염의 군주', '레드 드래곤'], desc: '용들이 거주하는 전설의 장소입니다.', eventChance: 0.28, boss: true },

    // 사막 지역 (Lv 15-25)
    '사막 오아시스': { level: 15, type: 'safe', exits: ['서쪽 평원', '피라미드'], monsters: [], desc: '사막 한가운데 있는 오아시스 마을입니다.', eventChance: 0 },
    '피라미드': { level: 20, type: 'dungeon', exits: ['사막 오아시스'], monsters: ['미라', '사막도적', '스핑크스', '아누비스 수호자'], bossMonsters: ['스핑크스', '아누비스 수호자'], desc: '고대 왕이 잠든 거대한 피라미드입니다.', eventChance: 0.24, boss: true },

    // 얼음 지역 (Lv 20-35)
    '얼음 성채': { level: 20, type: 'dungeon', exits: ['잊혀진 폐허', '빙하 심연', '북부 요새'], monsters: ['프로스트 위치', '얼음 거인', '스노우 울프', '아이스 골렘'], desc: '영원히 얼어붙은 고대 성채입니다.', eventChance: 0.22 },
    '빙하 심연': { level: 30, type: 'dungeon', exits: ['얼음 성채'], monsters: ['아이스 드래곤', '빙결의 마녀', '서리 정령'], bossMonsters: ['아이스 드래곤', '빙결의 마녀'], desc: '깊은 빙하 속에 숨겨진 심연입니다.', eventChance: 0.28, boss: true },
