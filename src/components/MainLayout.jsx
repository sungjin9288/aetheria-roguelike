...
const MainLayout = ({ children, visualEffect }) => (
  <div
    data-app-shell
    className={`flex h-[100dvh] w-full flex-col overflow-x-hidden overflow-y-auto p-2 pt-[calc(env(safe-area-inset-top)+0.35rem)] pb-[calc(env(safe-area-inset-bottom)+0.5rem)] font-mono text-slate-200 relative ${visualEffect === 'shake' ? 'animate-shake' : ''}`}
    onClick={(e) => {
