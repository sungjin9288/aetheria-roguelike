...
const MainLayout = ({ children, visualEffect }) => (
  <div className={`flex flex-col min-h-[100dvh] w-full bg-slate-950 text-slate-200 font-mono p-2 md:p-4 overflow-hidden relative ${visualEffect === 'shake' ? 'animate-shake' : ''}`}>
    {children}
